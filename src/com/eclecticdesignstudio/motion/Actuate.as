package com.eclecticdesignstudio.motion {
	...
	public class Actuate {
		 ...
		 */
		public static function stop (target:Object, properties:Object = null, complete:Boolean = false,sendEvent:Boolean=false):void {
			...
			if (target) {
				...
				for each (actuator in library) {
					...
					actuator.MotionInternal::stop (properties, complete, sendEvent);
